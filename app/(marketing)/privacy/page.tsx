...
const PrivacyPolicy: NextPage = () => {
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <p className="mb-4 text-sm">Last updated: July 06, 2024</p>
      <p className="mb-4">
        Welcome to Sociagram. We value your privacy and are committed to
        protecting your personal information. This Privacy Policy describes Our
      ...
      <ul className="mb-4 list-inside list-disc">
        ...
        <li className="mb-2">
          <strong>Application</strong> refers to Sociagram, the software program
          provided by the Company.
        </li>
        <li className="mb-2">
          <strong>Company</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
          this Agreement) refers to Aisely Limited, No 11, Road 61, Federal
          Housing Estate, Obada-Oko, Ogun State.
        </li>
      ...
      <p className="mb-4">
        ...
        IP address of Your mobile device, Your mobile operating system, unique
      ...
      <p className="mb-4">
        ...
        account, such as Your name, Your email address or Your activities
      ...
      <ul className="mb-4 list-inside list-disc">
        <li className="mb-2">
          <strong>
            To present Our Service and obtain Your consent, including for some
            features We may ask You to sign up or register for Our Service.
          </strong>
        </li>
        <li className="mb-2">
          <strong>To measure the usage and performance of Our Service:</strong>{' '}
          We may use information collected to measure service usage and
          performance.
        </li>
        <li className="mb-2">
          <strong>To improve, customize and expand Our Service:</strong> We may
          use information collected to improve and customize Our Service,
          including to:
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          ...
          of Our assets, whether as a going concern or as part of liquidation,
          or similar proceeding, in which Personal Data held by Us about our
          Service users is among the assets transferred.
        </li>
        <li className="mb-4">
          <strong>For other purposes:</strong> We may use Your information for
          other purposes, such as data analysis, to debug to identify issue,
      ...
      {/* <h3 className="mb-2 hidden text-xl font-semibold">
        How We Use Your Information
      </h3> */}
      <p className="mb-4">
        We may share the information that We collect about You or retrieve from
        Your Device in the following situations:
      </p>
      <ul className="mb-4 list-inside list-disc">
        <li className="mb-2">
      ...
      <p className="mb-2">
        ...
        comply with applicable laws), to resolve disputes, enforce our legal
        agreements and policies, and to administer our business purposes.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        information may be transferred to — and maintained on behalf of —
        Company&apos;s affiliates, which may also be located outside of Your
        state, province, country or other governmental jurisdiction where the
        parties involved in the processing are located, where the data
      ...
      <h4 className="mb-2 text-lg font-semibold">Business Transactions</h4>
      <p className="mb-4">
      ...
      <h4 className="mb-2 text-lg font-semibold">Law enforcement</h4>
      <p className="mb-4">
      ...
      <h4 className="mb-2 text-lg font-semibold">Other legal requirements</h4>
      <p className="mb-4">
      ...
      <p className="mb-2">
        ...
        prior to the change becoming effective, that the Privacy Policy has been
        updated and update the &quot;Last updated&quot; date at the top of this
        Privacy Policy.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        If you have any questions about this Privacy Policy, if you want to
        request that We delete Your account, or for any other concern, You can
        contact us:
      </p>
      <ul className="mb-4 list-inside list-disc">
        <li className="mb-2">By email: beyuppie365@gmail.com</li>
        <li className="mb-2">
